...
async def analyse_drawing(
    ...
    # Run compliance analysis. Topology extraction only runs when DXF components are available
    # (image-only topology is unreliable for complex multi-page drawings).
